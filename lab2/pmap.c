...
void mips_detect_memory()
{
	...
	* (When use real computer, CMOS tells us how many kilobytes there are). */
	u_long maxpa = 4294967295;            /* Maximum physical address */
	u_long npage = 1048576;            /* Amount of memory(in pages) */
	u_long basemem = 67108864;         /* Amount of base memory(in bytes) */
	u_long extmem = 4032 * 1024 * 1024;
